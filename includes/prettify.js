...
(function () {
  ...
  var ALL_KEYWORDS = [
      CPP_KEYWORDS, JSCRIPT_KEYWORDS, PERL_KEYWORDS, PYTHON_KEYWORDS, SH_KEYWORDS];
  ...
  /**
   * token style for a variable.
   * @const
   */
  var PR_VARIABLE = 'variable';
  /**
   * token style for a function.
   * @const
   */
  var PR_FUNCTION = 'function';
  /**
   * token style for an sgml attribute name.
   * @const
   */
  var PR_ATTRIBUTE_NAME = 'attribute-name';
  /**
   * token style for an sgml attribute value.
   * @const
   */
  var PR_ATTRIBUTE_VALUE = 'attribute-value';
  ...
  registerLangHandler(
      ...
      ['in.tag']);
  registerLangHandler(
      createSimpleLexer([], [[PR_ATTRIBUTE_VALUE, /^[\s\S]+/]]), ['uq.val']);
  ...
  registerLangHandler(sourceDecorator({
          ...
          'types': /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/,
          'hashComments': true,
          'multiLineStrings': true,
  ...
  function $prettyPrint(opt_whenDone, opt_root) {
    ...
    var prettyPrintRe = /\bprettify\b/;
    var prettyPrintedRe = /\bprettified\b/;
      ...
      for (; k < elements.length && clock['now']() < endTime; k++) {
        ...
        if ((attrs !== EMPTY || prettyPrintRe.test(className))
          ...
          if (!nested) {
            ...
            var lineNums = attrs['line-numbers'];
            if (!(lineNums = lineNums === 'true' || +lineNums)) {
              lineNums = className.match(/\bline-numbers\b(?::(\d+))?/);
              lineNums =
                lineNums
  ...
  var PR = win['PR'] = {
        ...
        'PR_ATTRIBUTE_NAME': PR_ATTRIBUTE_NAME,
        'PR_ATTRIBUTE_VALUE': PR_ATTRIBUTE_VALUE,
        'PR_COMMENT': PR_COMMENT,
        'PR_DECLARATION': PR_DECLARATION,
        'PR_KEYWORD': PR_KEYWORD,
        'PR_LITERAL': PR_LITERAL,
        'PR_NO_CODE': PR_NO_CODE,
        'PR_PLAIN': PR_PLAIN,
